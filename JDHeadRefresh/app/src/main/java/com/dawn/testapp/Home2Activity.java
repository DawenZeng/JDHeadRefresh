...
import com.vip.common.headerview.JDHeaderView;
...
public class Home2Activity extends AppCompatActivity implements JDHeaderView.RefreshDistanceListener {
    ...
    private void initPtrFrame() {
        mPtrFrame = (JDHeaderView) findViewById(R.id.rotate_header_list_view_frame);
